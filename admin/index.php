  ...
  <div class="col-xl-6 col-md-12 mb-4">
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Male's Glasses</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800">
            <?php 
                $query = "SELECT glass_id FROM glass where gender='male' ORDER BY glass_id";  
                $query_run = mysqli_query($connection, $query);
                $row = mysqli_num_rows($query_run);
                echo '<h4> Total Male Glasses: '.$row.'</h4>';
             ?>
  ...
  <div class="col-xl-6 col-md-12 mb-4">
    <div class="card border-left-info shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
          <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Female's Glasses</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800">
            <?php 
                $query = "SELECT glass_id FROM glass where gender='female' ORDER BY glass_id";  
                $query_run = mysqli_query($connection, $query);
                $row = mysqli_num_rows($query_run);
                echo '<h4> Total Male Glasses: '.$row.'</h4>';
             ?>
