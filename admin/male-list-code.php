...
$file_size=$_FILES['fileToUpload']['size'];
    ...
    $query1 = "UPDATE glass
     SET  gname='$edit_gname',price='$edit_price',color='$edit_color',size='$edit_size',gender='$gender',description='$edit_description',image='$file_name' WHERE gender='male' && glass_id='$id' ";
...
if(isset($_POST['delete_btn']))
{
    ...
    $query = "DELETE FROM glass WHERE gender='male' && glass_id='$id' ";
    $query_run = mysqli_query($connection, $query);
