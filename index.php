            ...
            <div class="swiper-container main-slider swiper-arrow with-bg_white">
                <div class="swiper-wrapper">
                    <div class="swiper-slide animation-style-01">
                        <div class="slide-inner bg-height" data-bg-image="assets/images/slider/bg/slider1.jpg" >
                            <div class="container">
                                <div class="slide-content text-white">
                                    
                                    <h2 class="title mb-3">Glasses For Men And Women</h2>
                                    <p class="short-desc different-width mb-10">Exclusive Exchange Offer & 30% Off In This Week</p>
                                    <div class="button-wrap">
                                        <a class="btn btn-custom-size lg-size btn-primary" href="shop-female.php">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide animation-style-01">
                        <div class="slide-inner bg-height" data-bg-image="assets/images/slider/bg/slider4.jpeg" >
                            <div class="container">
                                <div class="slide-content text-white">
                                    ...
                                    <p class="short-desc different-width mb-10">Exclusive Exchange Offer & 30% Off In This Week</p>
                                    <div class="button-wrap">
                                        <a class="btn btn-custom-size lg-size btn-primary" href="shop-male.php">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
			...
			<div class="row row--2">
				...
				<div class="col-lg-4 col-sm-6 col-12">
					<div class="banner">
						<div class="thumb">
							<a href="#">
								<img src="assets\images\banner\banner-1.jpg" height="260px" alt="banner img">
							</a>
						</div>
					</div>
				</div>
